...
void Shell_init()
{
    Input_stream = kmalloc(4*1024*1024); // 4 mbs for the input stream
    Istream_ptr = (char*)Input_stream;
    Istream_end = Istream_ptr + (4*1024*1024);
...
{
    char* shell_buf;
    Main_CSI_struct = kmalloc(4096);
    CSI_mem_start = (uint32_t*)Main_CSI_struct;
    Shell_Commands_list = kmalloc(4096*1024);
